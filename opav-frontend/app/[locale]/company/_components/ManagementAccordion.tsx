      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <a
            ...
            aria-label={t("isoBadgeAria")}
            className="group inline-flex items-center gap-2 px-6 py-3 rounded-full text-sm font-medium font-['Inter'] transition-all duration-200 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-[#d50058] focus-visible:ring-offset-2"
            style={{
              background:
          ...
          >
            ...
            {/* Flecha que insinúa apertura del documento */}
            <svg
